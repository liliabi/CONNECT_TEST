<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TDT.aspx.cs" Inherits="iCouldTest.TDT" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>iCould TDT&TRG Testing</title>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="page-header">
                <span class="h2">Mapps TDT&TRG Cloud Migration Testing Page</span>
            </div>
        </div>
